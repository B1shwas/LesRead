...
const DropdownMenuItem = React.forwardRef(
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ref={ref}
      className={cn(
        "relative flex select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors   data-[disabled]:pointer-events-none data-[disabled]:opacity-50 bg-input-bg text-text-2 hover:bg-input-bg/70 hover:text-secondary-1 cursor-pointer",
        inset && "pl-8",
        className
      )}
      {...props}
