          ...
          <>
            <div className="flex flex-col gap-[32px]">
              ...
              <div className="px-6 border-l-2 border-button-pink text-white/40">
                ...
                Aperiam quod alias unde consectetur molestiae autem blanditiis
                nulla, facilis nobis odio sint quisquam veniam! Earum placeat
                dicta itaque eveniet ut doloribus officiis adipisci.
              </div>
              <div>
